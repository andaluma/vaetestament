...
en_slug: difc-will-vs-home-country-will
...
keywords:
  ...
  - DIFC-testament naast Nederlands testament
...
linked_landing_faq: difc-vs-nl-testament
faq:
  - q: Kan mijn Nederlandse notaris een DIFC-testament opstellen?
    a: Nee. Een DIFC-testament wordt geregistreerd bij het DIFC-testaments Service Centre in Dubai. Nederlandse notarissen hebben daar geen bevoegdheid. VAEtestament begeleidt het DIFC-traject volledig in het Nederlands.
  - q: Moet ik mijn Nederlandse testament aanpassen als ik een DIFC-testament neem?
  ...
  - q: Wat als ik ook vastgoed in andere landen heb (Spanje, Indonesië)?
    a: Voor elk land waar u onroerend goed bezit, moet u nagaan welk lokaal instrument nodig is. Een DIFC-testament dekt alleen VAE-vastgoed. Lees meer over [erfrecht in de VAE voor Nederlandse eigenaren](/artikelen/erfrecht-vae-nederlandse-vastgoedeigenaren/).
...
Vastgoed in de VAE valt onder VAE-jurisdictie. Zonder lokaal geldig testament kunnen de VAE-autoriteiten hun eigen erfregels toepassen. Een DIFC-testament is het instrument waarmee u als niet-moslim vastlegt wie uw VAE-vastgoed erft, afdwingbaar via het DIFC-rechtssysteem.
...
De DIFC-testament regelt: vastgoed op persoonlijke naam in de VAE (alle Emiraten).

De sleutel is dat beide documenten een heldere scope-afbakening hebben. Uw Nederlandse testament moet niet verwijzen naar uw VAE-vastgoed alsof het dat ook regelt. Uw DIFC-testament moet zich beperken tot uw VAE-bezittingen.

### De rol van uw notaris

Het is verstandig om uw Nederlandse notaris te informeren over het bestaan van uw DIFC-testament. Sommige notarissen nemen in het Nederlandse testament een clausule op die verwijst naar het feit dat voor buitenlands vastgoed een apart testament geldt. Dat voorkomt verwarring bij de afwikkeling.

Andersom hoeft het niet: uw DIFC-testament verwijst niet naar uw Nederlandse testament. Het DIFC-systeem opereert onafhankelijk.
...
Als uw Nederlandse testament een bepaling bevat die betrekking heeft op uw VAE-vastgoed (bijvoorbeeld: "al mijn onroerend goed, waar ook ter wereld, naar mijn partner"), kan dit in theorie conflicteren met uw DIFC-testament. In de praktijk gaat het DIFC-document voor als het om VAE-vastgoed gaat, maar het is verstandiger om de tegenstrijdigheid te voorkomen door uw Nederlandse testament aan te passen.

### Valkuil 3: vergeten om beide documenten bij te werken

Bij wijzigingen in uw gezinssituatie (scheiding, hertrouwen, geboorte, overlijden van een begunstigde) moeten mogelijk beide testamenten worden bijgewerkt. Eigenaren vergeten regelmatig het ene document bij te werken wanneer ze het andere wijzigen.
...
## Wanneer heeft u alleen een DIFC-testament nodig?

Als u geen vermogen in Nederland heeft (bijvoorbeeld omdat u permanent in het buitenland woont en al uw Nederlandse bezittingen heeft afgebouwd), heeft u mogelijk alleen een DIFC-testament nodig voor uw VAE-vastgoed. Raadpleeg een notaris in uw woonland voor advies over uw totale estate planning.

## Wanneer heeft u meer nodig dan een standaard DIFC-testament?

- **VAE-bezittingen buiten vastgoed:** bankrekeningen, aandelen, voertuigen in de VAE vereisen een uitgebreidere DIFC-testament-variant.
...
2. **Regel een DIFC-testament.** Het volledige proces verloopt op afstand en duurt 5 tot 10 weken. Lees het [stap-voor-stap overzicht](/artikelen/difc-will-registreren-vanuit-nederland/).
